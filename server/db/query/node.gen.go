...
func newNode(db *gorm.DB, opts ...gen.DOOption) node {
	...
	_node.Owner = field.NewString(tableName, "owner")
	_node.Parent = field.NewString(tableName, "parent")
...
func (n *node) updateTableName(table string) *node {
	...
	n.Owner = field.NewString(table, "owner")
	n.Parent = field.NewString(table, "parent")
...
func (n *node) fillFieldMap() {
	...
	n.fieldMap["owner"] = n.Owner
	n.fieldMap["parent"] = n.Parent
}
